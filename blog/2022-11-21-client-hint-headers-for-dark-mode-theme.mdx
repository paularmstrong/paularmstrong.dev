...
pubDate: 11/21/2022, 9:00:00 AM GMT-0700
...
1. The theme is tracked on the body element, using the `className` and `data-` attribute: `<body class="dark" data-auto-theme="true">`
