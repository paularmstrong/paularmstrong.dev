...
description: The problem with Web Components has and always will be that they were designed for the browser and not for the developer. As many features as they get, they're still ergonomically odd and difficult to maintain.
---
...
- **Three languages in one**
  ...
  I thought CSS-in-JS was such a bad thing? That’s what all the purists told me. Well now we’ve got CSS-in-JS and HTML-in-JS and now my editor needs to support three syntax higlighters in ever file and I need to hope my string templates all compile correctly.
