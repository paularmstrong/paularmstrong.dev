...
pubDate: 2023/03/11, 01:03:00 PM GMT-0800
---
...
- **Purists…**
  ...
  And the biggest thing that has put me off of Web Components? The people who I refer to as “purists” that keep shouting about how we’re all wrong for using something else. I get it, Web Components probably _are_ the better choice for the browser, performance, and end user when it is all said and done. But you’re the ones that created this stuff in a void – have you ever had to build a web application and maintain it for at least 5 years? Probably not since before 2010. Things were _different_ then.
