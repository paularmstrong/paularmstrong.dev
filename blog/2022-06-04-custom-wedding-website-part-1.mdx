...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture
		src="/img/blog/wedding/firebase.png"
		alt="Firebase logo"
		widths={[300, 600]}
		aspectRatio={1024 / 288}
		width={1024}
		height={288}
		loading="lazy"
		itemprop="image"
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture
		src="/img/blog/wedding/supabase.png"
		alt="Supabase logo"
		widths={[300, 600]}
		aspectRatio={2159 / 420}
		width={2159}
		height={420}
		loading="lazy"
		itemprop="image"
...
<div class="not-prose max-w-[480px] rounded bg-white p-4">
	<Picture
		src="/img/blog/wedding/parse.png"
		alt="Parse Platform logo"
		widths={[300, 378]}
		aspectRatio={378 / 133}
		width={378}
		height={133}
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture
		src="/img/blog/wedding/preact.webp"
		alt="Preact logo"
		widths={[300, 600]}
		aspectRatio={1900 / 572}
		width={1900}
		height={572}
		loading="lazy"
		itemprop="image"
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture
		src="/img/blog/wedding/tailwind.png"
		alt="Tailwindcss logo"
		widths={[300, 600]}
		aspectRatio={2560 / 315}
		width={2560}
		height={315}
		loading="lazy"
		itemprop="image"
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture
		src="/img/blog/wedding/parcel.png"
		alt="Parcel logo"
		widths={[300, 600]}
		aspectRatio={1492 / 516}
		width={1492}
		height={516}
		loading="lazy"
		itemprop="image"
