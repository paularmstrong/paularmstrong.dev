...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture src="/img/blog/wedding/firebase.png" alt="Firebase logo" widths={[300, 600]} aspectRatio={1024 / 288} />
</div>
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture
		src="/img/blog/wedding/aws-amplify.png"
		alt="AWS Amplify logo"
		widths={[300, 600]}
		aspectRatio={1838 / 550}
	/>
</div>
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture src="/img/blog/wedding/supabase.png" alt="Supabase logo" widths={[300, 600]} aspectRatio={2159 / 420} />
</div>
...
<div class="not-prose max-w-[480px] rounded bg-white p-4">
	<Picture src="/img/blog/wedding/parse.png" alt="Parse Platform logo" widths={[300, 378]} aspectRatio={378 / 133} />
</div>
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture src="/img/blog/wedding/preact.webp" alt="Preact logo" widths={[300, 600]} aspectRatio={1900 / 572} />
</div>
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture src="/img/blog/wedding/tailwind.png" alt="Tailwindcss logo" widths={[300, 600]} aspectRatio={2560 / 315} />
</div>
...
<div class="not-prose max-w-[480px] rounded bg-slate-50 p-4 dark:bg-slate-200">
	<Picture src="/img/blog/wedding/parcel.png" alt="Parcel logo" widths={[300, 600]} aspectRatio={1492 / 516} />
</div>
...
3. [Part 2: Setup](/blog/2022/06/04/custom-wedding-website/part-2)
