...
pubDate: 11/09/2022, 8:00:00 AM GMT-0800
...
<aside class="mx-4 mb-4 rounded-xl bg-slate-200 px-4 py-1 dark:bg-slate-800 sm:float-right sm:ml-8 sm:mr-0 sm:max-w-[50%] md:-mr-8 lg:-mr-32" aria-labelledby="aside-title">

<p id="aside-title">Check out the React Component Benchmark project example in [the Labs](/labs/).</p>
