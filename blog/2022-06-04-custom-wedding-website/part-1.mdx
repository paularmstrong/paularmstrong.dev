...
import awsAmplifyImage from './img/aws-amplify.png';
import supabaseLogo from './img/supabase.png';
import parseLogo from './img/parse.png';
import preactLogo from './img/preact.webp';
import parcelLogo from './img/parcel.png';
import tailwindLogo from './img/tailwind.png';

export function ImageWrapper({ children }) {
  return (
    <div style={{ backgroundColor: 'white', padding: 10, borderRadius: 5, maxWidth: '300px', overflow: 'hidden' }}>
      {children}
    </div>
  );
}
...
As a reminder, my partner and I set some requirements for this website in [this series introduction](./). (I'll be honest though, she didn't care too much about details, so this was really mostly me going a bit above and beyond)
...
<details>
  <summary>Click to expand altneratives considered ↕</summary>

#### AWS Amplify

<ImageWrapper>
  <Image img={awsAmplifyImage} alt="" />
</ImageWrapper>
