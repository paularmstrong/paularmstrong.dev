...
<section class="prose-sm prose mx-4 max-w-none rounded bg-slate-200 p-4 shadow-lg prose-headings:text-slate-800 prose-em:text-gray-500 dark:prose-invert dark:bg-slate-800 dark:prose-headings:text-slate-200 dark:prose-em:text-gray-400 md:mx-8 md:p-8 lg:prose-base xl:prose-lg">
<article>
...
_Use this section to provide details on how we will solve the problem stated at the beginning of this document. Be sure that all of the goals that have been enumerated will be met._
