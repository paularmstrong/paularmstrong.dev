...
<div class="not-prose float-right w-[38%] shape-circle">
  <Image loading="eager" src={Avatar} width={375} height={375} alt="" />
</div>
...
You may be familiar with some of my open source work, like [Normalizr](https://github.com/paularmstrong/normalizr), [reUI](https://reui.dev), [Build Tracker](https://buildtracker.dev), [React Component Benchmark](https://github.com/paularmstrong/react-component-benchmark), and [more on Github](https://github.com/paularmstrong 'Paul Armstrong’s Github profile').
