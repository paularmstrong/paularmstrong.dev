...
### Troon Digital, Remote - Principal Software Engineer

- February 2024 - Present

### Figure, Remote - Principal Software Engineer

- January 2023 - February 2024

Led efforts across Frontend teams to merge, migrate, and standardize code. Consolidated 10s of applications, modules, and repositories to a monorepo with shared code, standardized patterns & best practices, and streamlined processes.
