...
description: Working with git can be hard, verbose, and repetitive. I’ve been using this small collection of sh/zsh functions for a few years now and I don’t think I could work without them anymore.
---
...
```sh title="Add to your ~/.zshrc or ~/.shrc"
function rmbranch() {
