...
noHero: true
heroImage:
  src: /img/blog/2023-08-packages/packages.jpg
  width: 1152
  height: 574
---
...
<Picture
  ...
  formats={['avif', 'jpeg']}
  style="view-transition-name: hero-the-line-between-writing-functions-yourself-and-using-open-source-modules"
/>
...
<Picture
  src="/img/blog/2023-08-packages/juice-squeeze.jpg"
  width={1152}
  height={574}
  widths={[1152, 768]}
  alt="AI generated image of oranges being squeezed into orange juice"
  formats={['avif', 'jpeg']}
/>
